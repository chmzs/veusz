...
class PreferencesDialog(VeuszDialog):
    ...
    def __init__(self, mainwindow):
        ...
        self.translationBrowseButton.clicked.connect(self.translationBrowseClicked)

        # use cwd for file dialogs
        (
            self.dirDocCWDRadio if setdb["dirname_usecwd"] else self.dirDocPrevRadio
        ).click()
        ...
        self.securityDirList.itemSelectionChanged.connect(self.securityDirListSelection)
    ...
    def securityDirListSelection(self):
        ...
        self.securityDirRemove.setEnabled(len(self.securityDirList.selectedItems()) > 0)
