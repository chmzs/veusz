...
class ExportDialog(VeuszDialog):
    ...
    def __init__(self, mainwindow, doc, docfilename):
        ...
        self.buttonBox.button(qt.QDialogButtonBox.StandardButton.Save).setText(
            _("Export")
        )
        ...
        self.exportBackgroundButton.clicked.connect(self.slotExportBackgroundClicked)
    ...
    def formatClicked(self, fmt):
        ...
        for c in (
            ...
            self.exportDPI,
            self.labelDPI,
            self.exportBackgroundButton,
            self.labelBackgroundButton,
        ):
    ...
    def accept(self):
        ...
        if (
            ...
            self.showMessage(_("Error: page name or number must be in filename"))
            return
        ...
        self.buttonBox.button(qt.QDialogButtonBox.StandardButton.Close).setEnabled(
            False
        )
        ...
        def checkDone():
            ...
            self.buttonBox.button(qt.QDialogButtonBox.StandardButton.Save).setEnabled(
                True
            )
