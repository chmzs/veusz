...
class Volume3D(plotters3d.GenericPlotter3D):
    ...
    def addSettings(klass, s):
        ...
        s.add(
            setting.DatasetExtended(
                "zData", "z", descr=_("Z dataset"), usertext=_("Z data")
            ),
            0,
        )
        s.add(
            setting.DatasetExtended(
                "yData", "y", descr=_("Y dataset"), usertext=_("Y data")
            ),
            0,
        )
        s.add(
            setting.DatasetExtended(
                "xData", "x", descr=_("X dataset"), usertext=_("X data")
            ),
            0,
        )
        s.add(DataColor("DataColor", dimensions=1), 0)
        ...
        s.add(
            setting.Line3D("Line", descr=_("Line settings"), usertext=_("Box line")),
    ...
    def dataDrawToObject(self, painter, axes):
        ...
        cmap = self.document.evaluate.getColormap(s.colorMap, s.colorInvert)
