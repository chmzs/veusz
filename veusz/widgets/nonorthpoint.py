...
class NonOrthPoint(Widget):
    ...
    def addSettings(klass, s):
        ...
        s.add(
            setting.DatasetExtended(
                "data1",
                "x",
                descr=_("Dataset containing 1st dataset, list of values or expression"),
        ...
        s.add(
            setting.DatasetExtended(
                "data2",
                "y",
                descr=_("Dataset containing 2nd dataset, list of values or expression"),
        ...
        s.add(
            MarkerFillBrush(
                "MarkerFill", descr=_("Marker fill settings"), usertext=_("Marker fill")
            ),
    ...
    def userdescription(self):
        return _("data1='%s', data2='%s'") % (self.settings.data1, self.settings.data2)
    ...
    def pickPoint(self, x0, y0, bounds, distance="radial"):
        p = pickable.DiscretePickable(
            self, "data1", "data2", lambda v1, v2: self.parent.graphToPlotCoords(v1, v2)
        )
    ...
    def draw(self, parentposn, phelper, outerbounds=None):
        ...
        with painter:
            ...
            for (
                ...
                cvals,
                textitems,
            ) in datasets.generateValidDatasetParts(
