...
class BoxPlot(GenericPlotter):
    ...
    def addSettings(klass, s):
        ...
        s.add(
            setting.GraphBrush("Fill", descr=_("Box fill"), usertext=_("Box fill")),
        ...
        s.add(
            setting.BoxPlotMarkerFillBrush(
                "MarkersFill", descr=_("Markers fill"), usertext=_("Markers fill")
            ),
    ...
    def dataDraw(self, painter, axes, widgetposn, clip):
        ...
        if s.calculate:
            ...
            for vals, plotpos in zip(values, plotposns):
                ...
                self.plotBox(painter, axes, plotpos, widgetposn, width, clip, stats)
        else:
            ...
            for i in range(min(lens)):
                ...
                self.plotBox(painter, axes, vals[6][i], widgetposn, width, clip, stats)
