...
class Line(Settings):
    ...
    def __init__(self, name, **args):
        ...
        self.add(
            setting.LineStyle(
                "style", "solid", descr=_("Line style"), usertext=_("Style")
            )
        )
        self.add(
            setting.Int(
        ...
        self.add(
            setting.Bool("hide", False, descr=_("Hide the line"), usertext=_("Hide"))
        )
    ...
    def makeQPen(self, painter):
        ...
        if self.transparency > 0:
            color.setAlphaF((100 - self.transparency) / 100.0)
    ...
    def __init__(self, name, **args):
        ...
        self.add(
            setting.SettingBackwardCompat(
                ...
                "interpType",
                False,
                translatefn=lambda x: {True: "loose-Bezier", False: "linear"}[x],
                formatting=True,
            )
        )
...
class Brush(Settings):
    ...
    def __init__(self, name, **args):
        ...
        self.add(
            setting.Color(
                "color", "foreground", descr=_("Fill colour"), usertext=_("Color")
            )
        )
        self.add(
            setting.FillStyle(
                "style", "solid", descr=_("Fill style"), usertext=_("Style")
            )
        )
        self.add(
            setting.Int(
        ...
        self.add(
            setting.Bool("hide", False, descr=_("Hide the fill"), usertext=_("Hide"))
        )
...
class BrushExtended(Settings):
    ...
    def __init__(self, name, **args):
        ...
        self.add(
            setting.GradientFill(
                "Gradient", descr=_("Gradient fill settings"), usertext=_("Gradient")
            )
        )
...
class PlotterFill(BrushExtended):
    ...
    def __init__(self, name, **args):
        ...
        self.add(
            setting.Choice(
                "fillto",
                ["auto", "top", "bottom", "left", "right", "custom", "mean"],
                "auto",
...
class PointFill(BrushExtended):
    ...
    def __init__(self, name, **args):
        ...
        self.add(
            setting.Choice(
                "fillto",
                ["top", "bottom", "left", "right", "custom", "mean"],
                "top",
                descr=_("Edge to fill towards"),
                usertext=_("Fill to"),
            ),
...
class ArrowFill(Brush):
    ...
    def __init__(self, name, **args):
        ...
        self.get("color").newDefault(setting.Reference("../Line/color"))
...
class Text(Settings):
    ...
    def __init__(self, name, **args):
        ...
        self.add(
            setting.Bool("italic", False, descr=_("Italic font"), usertext=_("Italic"))
        )
        self.add(setting.Bool("bold", False, descr=_("Bold font"), usertext=_("Bold")))
        self.add(
            setting.Bool(
                "underline", False, descr=_("Underline font"), usertext=_("Underline")
            )
        )
        self.add(
            setting.Bool("hide", False, descr=_("Hide the text"), usertext=_("Hide"))
        )
...
class Surface3D(Settings):
    ...
    def __init__(self, name, **args):
        ...
        self.add(
            setting.Color(
                "color", "grey", descr=_("Color of surface"), usertext=_("Color")
            )
        )
        self.add(
            setting.FloatSlider(
        ...
        self.add(
            setting.Bool("hide", False, descr=_("Hide surface"), usertext=_("Hide"))
        )
...
class Lighting3D(Settings):
    ...
    def __init__(self, name, **args):
        ...
        self.add(
            setting.Bool(
                "enable", True, descr=_("Enable lighting"), usertext=_("Enable")
            )
        )
        self.add(
            setting.Color(
                "color", "white", descr=_("Color of lighting"), usertext=_("Color")
            )
        )
        self.add(
            setting.FloatSlider(
