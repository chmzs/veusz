...
class FieldCombo(Field):
    ...
    def __init__(self, name, descr=None, default=None, items=(), editable=True):
        """name: name of field
        descr: description to show to user
        default: default value
...
class _FieldSetting(Field):
    ...
    def __init__(self, settingkls, name, descr=None, default="", setnparams={}):
        Field.__init__(self, name, descr=descr, default=default)
        self.default = default
...
class FieldBool(_FieldSetting):
    ...
    def __init__(self, name, descr=None, default=False):
        _FieldSetting.__init__(self, setting.Bool, name, descr=descr, default=default)


class FieldInt(_FieldSetting):
    """An integer number field."""

    def __init__(self, name, descr=None, default=0, minval=-9999999, maxval=9999999):
        """name: name of field
        descr: description to show to user
        default: default value.
...
class FieldFloat(_FieldSetting):
    ...
    def __init__(self, name, descr=None, default=None, minval=-1e99, maxval=1e99):
        """name: name of field
        descr: description to show to user
        default: default value.
...
class FieldColor(_FieldSetting):
    ...
    def __init__(self, name, descr=None, default="black"):
        _FieldSetting.__init__(self, setting.Color, name, descr=descr, default=default)
...
class FieldMarker(_FieldSetting):
    ...
    def __init__(self, name, descr=None, default="circle"):
        _FieldSetting.__init__(self, setting.Marker, name, descr=descr, default=default)
...
class FieldArrow(_FieldSetting):
    ...
    def __init__(self, name, descr=None, default="none"):
        _FieldSetting.__init__(self, setting.Arrow, name, descr=descr, default=default)
...
class FieldDataset(_FieldSetting):
    ...
    def __init__(self, name, descr=None, default="", dims=1, datatype="numeric"):
        """name: name of field
        descr: description to show to user
...
class FieldLineMulti(_FieldSetting):
    ...
    def __init__(self, name, descr=None, default=(("solid", "1pt", "black", False),)):
        _FieldSetting.__init__(
